...
## 📋 System Requirements
To run the **claude-skill-railway** application, ensure you meet the following requirements:

- **Operating System:** Windows 10 or later, macOS Mojave (10.14) or later, or Ubuntu 18.04 or later.
- **RAM:** Minimum 4 GB recommended.
- **Storage:** At least 100 MB of free space.
- **Network:** Internet connection for downloading the application and updates.

## 👨‍💻 Features
- **Simple CLI Commands:** Use straightforward commands to deploy applications without the need for extensive coding knowledge.
- **Deployment Management:** Easily manage multiple deployments with simple commands.
- **Cross-Platform Support:** Works on Windows, macOS, and Linux.
- **User-Friendly Documentation:** Clear instructions to guide you through each command.
...
- **On macOS:**
  ...
  2. Drag the `claude-skill-railway` application to your Applications folder.
...
## 🛠️ Usage
Once installed, you can start using the application. Open your command line interface (Command Prompt on Windows, Terminal on macOS and Linux) and type in the following command to check if the installation was successful:

```
claude-skill-railway --version
```
...
```
claude-skill-railway deploy [application_name]
```

- **List Deployments:**
```
claude-skill-railway list
```

- **Update a Deployment:**
```
claude-skill-railway update [application_name]
```

For more detailed command usage, please consult the **User Guide** within the application or on the GitHub repository.
